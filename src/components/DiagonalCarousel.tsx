  ...
  return (
    ...
    >
      ...
      {showControls && (
        <div
          className={cn(
            "absolute inset-x-4 bottom-5 z-10 mx-auto flex w-fit items-center justify-center gap-3 rounded-full border border-white/10 bg-neutral-900/70 px-2 text-neutral-100 shadow-sm backdrop-blur-sm",
            controlsClassName
          )}
        >
          <button
